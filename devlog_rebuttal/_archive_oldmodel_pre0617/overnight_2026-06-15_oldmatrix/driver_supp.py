...
Runs every (model, hw, task[, ablation]) in manifest_supp.json serially (they share
...
manifest = json.load(open(f"{BASE}/manifest_supp.json"))
summary_csv = f"{BASE}/summary_supp.csv"
summary_json = f"{BASE}/summary_supp.json"
