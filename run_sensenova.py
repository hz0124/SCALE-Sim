...
from simulation_core.sensenova_sim import Sensenova_sim
def main():
    """主函数"""

    parser = argparse.ArgumentParser(description="Run SenseNova Simulation")
    ...
    print(f"Starting SenseNova Simulation...")
    ...
    # 实例化SenseNova仿真类
    janus = Sensenova_sim(hardware_type=args.hw, task=args.task)
